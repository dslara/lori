...
│  ════════════════════════════════════════════════════════   │
│  Commands /ul-* — Interface principal via TUI               │
│                                                             │
│  Cada command define:                                       │
...
│  ════════════════════════════════════════════════════════   │
│  Skills mantidas — Guias especializados                   │
│                                                             │
...
> **Documentação completa**: [`docs/agents.md`](docs/agents.md) — Visão detalhada de cada agente, commands, skills e ciclo de uso.
...
| `#review-tools` | Qualidade das tools |
| `#review-docs` | Documentação |
| `#review-commands` | Commands `/ul-*` |
| `#review-agents` | Agentes |
| `#review-skills` | Skills |
| `#review-consistency` | Análise completa |
| `#review-costs` | Otimização de tokens |

> **Documentação completa**: [`docs/agents.md`](docs/agents.md) — Detalhes de cada keyword e uso.
...
| `.opencode/commands/` | Commands `/ul-*` (interface principal) | — |
| `.opencode/tools/` | Tools TypeScript (processamento de dados) | — |
...
**Benefícios sobre a versão anterior**:
- Interface unificada via TUI
- Sem keywords dispersas entre agentes
- Tipagem Zod para validação
- 100% TypeScript (sem scripts bash)
